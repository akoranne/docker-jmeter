[![Docker Build](https://img.shields.io/docker/automated/justb4/jmeter.svg)](https://hub.docker.com/r/askxtreme/jmeter)
...
Find Images of this repo on [Docker Hub](https://hub.docker.com/r/askxtreme/jmeter).
...
of the pre-built Images from [Docker Hub](https://hub.docker.com/r/askxtreme/jmeter).
...
1. In a Terminal/Command session, install Git, navigate/make a folder, then:
   ...
   ```
   git clone https://github.com/askxtreme/docker-jmeter.git
   cd docker-jmeter
   ```
...
1. Run the Build script to download dependencies, including the docker CLI:
   ...
   <tt>Successfully tagged askxtreme/jmeter:5.1.1</tt>
